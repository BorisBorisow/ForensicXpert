...
SECRET_KEY = 'django-insecure-1flp)e^b1--d86@^x#khfgm97r)4y7ks7ny&8j+v9s5r)&1ds7'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'forensic.sqlite3',
    }
}
...
LOGIN_REDIRECT_URL = reverse_lazy('after_login_view')
