...
class Employee(models.Model):
    ...
    UPLOAD_DIR = 'images/employees_profile_pictures'
    MOBILE_MAX_LENGTH = 14
    MOBILE_MIN_LENGTH = 10
    MOBILE_REGEX = r'^(\+?\d{10,14})$'
    ...
    last_name = models.CharField(max_length=LAST_NAME_MAX_LENGTH, blank=False, null=False)
    mobile = models.CharField(
        max_length=MOBILE_MAX_LENGTH,
        validators=[
            MinLengthValidator(MOBILE_MIN_LENGTH),
            RegexValidator(
                regex=MOBILE_REGEX,
                message=_('Mobile number must be 10 to 14 digits and can start with a plus sign.'),
            ),
        ],
        null=True,
        blank=True,
...
class ContactPerson(models.Model):
    gender = models.CharField(max_length=9, choices=gender, default="Unknown", null=True, blank=True)
