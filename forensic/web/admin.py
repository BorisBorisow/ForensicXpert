...
from web.models import Exhibit, ExhibitComponent, ExhibitDataImage, Client, ContactPerson, Mandate, \
    ClientCategory, ExhibitType, ExhibitDataImageType
...
class ExhibitTypeAdmin(admin.ModelAdmin):
    list_display = ('denotation', 'short')

@admin.register(ExhibitDataImageType)
class ExhibitDataImageTypeAdmin(admin.ModelAdmin):
    list_display = ('denotation', 'short')
